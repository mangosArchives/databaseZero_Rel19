...
DELETE FROM `creature_involvedrelation` WHERE `quest` = 8797 OR 8869 OR 9085 OR 9094 OR 9153 OR 9154 OR 9165 OR 9247 OR 9261 OR 9262 OR 9263 OR 9264 OR 9292 OR 9295 OR 9299;
DELETE FROM `creature_involvedrelation` WHERE `quest` = 9300 OR 9301 OR 9302 OR 9304 OR 9310 OR 9319 OR 9322 OR 9323 OR 9333 OR 9339 OR 9365 OR 9386;
...
DELETE FROM `creature_questrelation` WHERE `quest` = 7364 OR 7365 OR 7660 OR 7661 OR 7662 OR 7663 OR 7664 OR 7665 OR 7671 OR 7672 OR 7673 OR 7674 OR 7675;
DELETE FROM `creature_questrelation` WHERE `quest` = 7676 OR 7677 OR 7678 OR 8266 OR 8267 OR 8268 OR 8269 OR 8289 OR 8290 OR 8295 OR 8356 OR 8461 OR 8481;
DELETE FROM `creature_questrelation` WHERE `quest` = 8484 OR 8579 OR 8616 OR 8659 OR 8763 OR 8792 OR 8795 OR 8796 OR 8869 OR 8980 OR 8983 OR 9025 OR 9027;
DELETE FROM `creature_questrelation` WHERE `quest` = 9085 OR 9094 OR 9153 OR 9154 OR 9154 OR 9261 OR 9262 OR 9263 OR 9264 OR 9292 OR 9310 OR 9319 OR 9322;
DELETE FROM `creature_questrelation` WHERE `quest` = 9323 OR 9333 OR 9339 OR 9365 OR 9386;
